...
# the version string.
SET(MISSION_NAME "BEE")
SET(MISSIONCONFIG "bee")
...
SET(TGT1_APPLIST cfs_lib bee_lib ifc_lib adcs_lib ifcapp fm eps uant grx stx pays payr adcs payc utrx log hk ds sch ci to sn)
SET(TGT1_FILELIST cfe_es_startup.scr)

SET(TGT2_NAME obc)
SET(TGT2_SYSTEM obc) # important !!!!!
SET(TGT2_APPLIST cfs_lib bee_lib ifc_lib adcs_lib ifcapp fm eps uant grx stx pays payr adcs payc utrx log hk ds sch ci to sn)
SET(TGT2_FILELIST cfe_es_startup.scr)

########## ########## ########## ########## ##########
add_definitions(-DBEE_COMS_TEST)
# add_definitions(-DBEE_COMS_RF)

# add_definitions(-DBEE_LOG_ON)
########## ########## ########## ########## ##########
